...
SELECT name, population / 1000000 AS population_in_mlns
FROM world
...
SELECT name, ROUND(population/1000000, 2) AS population_in_mlns, ROUND(gdp/1000000000, 2) AS gdp_in_blns
FROM world
WHERE continent = 'South America'
